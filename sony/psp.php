...
<html lang="en">
<head>
    <title>Roms - Playstation Portable - PowerSRV</title>
  ...
  <div class="container">
    ...
    <p class="col col-complementary" role="complementary">
        <div class="standard-dialog">
          <p class="heading center">Playstation Portable</p>
            ...
            <table style="fit-content" border="1" width=100%>
                    <?php                        
                        $i=0;
                        $result = mysqli_query($con,"SELECT * FROM main WHERE platform='psp' {$parameter2 }{$parameter};");
