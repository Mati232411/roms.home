...
<html lang="en">
<head>
    <title>Roms - Playstation 3 - PowerSRV</title>
        ...
        <div class="standard-dialog">
          <p class="heading center">Playstation 3</p>
            ...
            <table style="fit-content" border="1" width=100%>
                    <?php                        
                        $i=0;
                        $result = mysqli_query($con,"SELECT * FROM main WHERE platform='ps3' {$parameter};");
